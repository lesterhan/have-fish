// Pure logic for the batch settle-up flow. The sheet is a thin shell over these
// helpers so the payload-building rules can be unit-tested without a renderer.
//
// Ported near-verbatim from frontend/src/lib/fish-pie-settle.ts — keep the two in
// sync so the mobile and web settle flows stay identical.
...
// Editable per-line state in the batch settle sheet.
