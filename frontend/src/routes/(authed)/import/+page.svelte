<script lang="ts">
  ...
  import ImportPreviewPanel from '$lib/components/ImportPreviewPanel.svelte'
  import ParsersPanel from '$lib/components/ParsersPanel.svelte'
  import type { RowState } from '$lib/components/ImportPreviewPanel.svelte'
